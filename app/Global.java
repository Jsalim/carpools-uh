...
public class Global extends GlobalSettings{
  ...
  public void onStart(Application app) {
    ...
    User.add(-1, "awang",     "Alvin Wang",           false,  "No smoking or eating please try to be on time.");
    ...
    User.add(-1, "nsmith",    "Nicholas Smith",       false,  "I expect you to be sober.");
    User.add(-1, "lli",       "Leo Li",               false,  "Must have good hygiene please.");
    User.add(-1, "tchida",    "Terrance Chida",       true,   "");
    User.add(-1, "jknaus",    "Jaki Knaus",           true,   "");
    User.add(-1, "jlee",      "Janis Lee",            false,  "");
    User.add(-1, "kpaek",     "Kevin Paek",           false,  "");
    */
  }
}
